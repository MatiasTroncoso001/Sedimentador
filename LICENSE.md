...
Bajo los siguientes términos:
  ...
  - Atribución — Usted debe dar crédito de manera adecuada,
    ...
    razonable, pero no de forma tal que sugiera que la
    licenciante lo respalda a usted o su uso.

  - CompartirIgual — Si usted remezcla, transforma o crea a
    partir del material, debe distribuir su contribución bajo
    la misma licencia que el original.

  - No hay restricciones adicionales — No puede aplicar términos
    legales ni medidas tecnológicas que legalmente restrinjan
    realizar aquello que la licencia permite.

Texto legal completo (inglés):
https://creativecommons.org/licenses/by-sa/4.0/legalcode

Resumen legible por humanos (español):
...
Troncoso Araya, M. (2025-2026). Laboratorio Virtual de
Sedimentadores Circulares [Recurso Educativo Abierto].
Programa STEAM, Facultad de Ingeniería, Universidad del
Bío-Bío. Licencia CC BY-SA 4.0.
